								...
								<div class="observer-container" style="height: auto;">
									<section class="topic-filter-section">
										...
										<ul class="topic">
											...
											<!-- 고수소식 -->
											<li class="selected"><a class="topic-link-item router-link-active" href="javascript:location.href='${contextPath}/QnAlistMysqlOk.post'">
													<div class="icon-wrapper">
														<img
															src="https://d2xc1tuir9mfs4.cloudfront.net/upload/profile/8dbafccb-92f6-4be2-b50c-a4eade43585f.png">
													</div> <span
													class="sg-text-subhead4 sg-font-bold sg-text-gray-900">MySQL</span>
											</a></li>
