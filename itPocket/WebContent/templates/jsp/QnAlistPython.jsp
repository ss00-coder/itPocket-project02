								...
								<div class="observer-container" style="height: auto;">
									<section class="topic-filter-section">
										...
										<ul class="topic">
											...
											<!-- 고수찾아요 -->
											<li  class="selected"><a class="topic-link-item router-link-active" href="javascript:location.href='${contextPath}/QnAlistPythonOk.post'">
													<div class="icon-wrapper">
														<img
															src="https://d2xc1tuir9mfs4.cloudfront.net/upload/profile/b3326101-bf1e-4004-8fa1-b5a0724f9e62.png">
													</div> <span
													class="sg-text-subhead4 sg-font-bold sg-text-gray-900">Python</span>
											</a></li>
											<!-- 함께해요 -->
