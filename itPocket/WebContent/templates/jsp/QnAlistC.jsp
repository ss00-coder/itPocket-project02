								...
								<div class="observer-container" style="height: auto;">
									<section class="topic-filter-section">
										...
										<ul class="topic">
											...
											<!-- 얼마예요 -->
											<li class="selected"><a class="topic-link-item router-link-active" href="javascript:location.href='${contextPath}/QnAlistCOk.post'">
													<div class="icon-wrapper">
														<img
															src="https://d2xc1tuir9mfs4.cloudfront.net/upload/community/a283e912-b56e-4310-8fa1-2c619bd0332d.png">
													</div> <span
													class="sg-text-subhead4 sg-font-bold sg-text-gray-900">c</span>
											</a></li>
											<!-- 고수찾아요 -->
