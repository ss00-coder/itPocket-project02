...
<link rel="stylesheet" href="../../static/css/gosu-search.css">
    ...
    <div id="app-body">
        ...
        <main class="page-content">
            ...
            <header class="page-header">
                ...
                <h1 class="page-heading-h1 text-white">서울</h1>
                <button type="button" class="btn btn-location btn-link">
                    <span>서울</span>
                    <img src="data:image/svg+xml;base64,"
                        alt="">
                </button>
                <!-- 배경 사진 -->
                <img src="" alt="배경" class="google-map">
            </header>

            <!-- 중간부 -->
            <div class="container">
                <nav class="page-nav text-lg-center">
                    <h3 class="page-heading-h3 font-weight-bold f-s-18-24">
                        서울 지역 인기 서비스
                    </h3>
                    <ol class="page-breadcrumbs list-inline">
                        <!-- 사이에 > 표시를 못찾았어요... -->
                        <li>
                        ...
                        <li>
                            <img class="arrow-img" src="data:image/svg+xml;base64," alt="">
                        </li>
                        <li>
                            <a href="" class="router-link-active">서울</a>
                        </li>
                    </ol>
                </nav>
                ...
                <!-- 복사해서 사용하기 -->
                <ul class="row">
                    <li class="service-link-column col-lg-4 col-12">
                        <!-- 링크 걸어두기 -->
                        <a href="">고수 이름 : ???</a>
                    </li>
                    <li class="service-link-column col-lg-4 col-12">
                ...
                <a href="" class="btn btn-more ml-auto mr-auto btn-outline-primary btn-block">고수 더보기</a>
            </div>
        </main>
        <!-- 푸터 -->
