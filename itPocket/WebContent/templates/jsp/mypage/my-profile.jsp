...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/mypage-setting-css/my-profile.css">
		...
		<div class="provider-profile">
			<c:choose>
				<c:when test="${not empty memberFileName}">
					<div class="profile-header" style="background-image: url(${pageContext.request.contextPath}/upload/${memberFileName})">
						<div class="backdrop"></div>
					</div>
				</c:when>
				<c:otherwise>
					<div class="profile-header" style="background-image: url(${pageContext.request.contextPath}/static/image/profile_icon.png)">
						<div class="backdrop"></div>
					</div>					
				</c:otherwise>
			</c:choose> 
					...
					<div class="profile-section col-lg-auto col-12">
						<div class="profile-body">
							<div class="profile-overview">
								<div class="thumb">
									<div class="user-profile-picture">
										<c:choose>
											<c:when test="${not empty memberFileName}">
												<div class="is-square" lazy="loaded" style="background-image: url(${pageContext.request.contextPath}/upload/${memberFileName})"></div>
											</c:when>
											<c:otherwise>
												<div class="is-square" lazy="loaded" style="background-image: url(${pageContext.request.contextPath}/static/image/profile_icon.png)"></div>
											</c:otherwise>
										</c:choose> 
									</div>
								</div>
								<div class="info">
									<div class="info-section-header">
										<h1 class="nickname"> <c:out value="${memberNickname}"/> 전문가 </h1>
										<button type="button" class="btn share-button btn-none"></button>
									</div>
									<div class="info-section-sub-header">
										<div class="category">지역&nbsp&nbsp<c:out value="${memberRegion}"/>&nbsp&nbsp&nbsp</div>
										<div class="category">이메일&nbsp&nbsp<c:out value="${memberEmail}"/></div>
									...
									<div class="detail-info">
										<div class="statistics-info">
											<div class="statistics-info-item review-info">
												<div class="statistics-info-item-header review-rate">총 추천<span></span></div>
												<div class="statistics-info-item-contents">
													<img src="${pageContext.request.contextPath}/static/image/like.png">
													<span class="rate">1234</span>
													<!-- <span class="count">회</span> -->
												</div>
											</div>
											<div class="statistics-info-item">
												<div class="statistics-info-item-header">칼럼</div>
												<div class="statistics-info-item-contents">123개</div>
											</div>
											<div class="statistics-info-item">
												<div class="statistics-info-item-header">답변</div>
												<div class="statistics-info-item-contents">123개</div>
											</div>
										</div>
									</div>
							...
							<ul class="sticky-nav has-price">
								<li tab-id="about" class="about active scroll-button">
									<a href="#pro-info"><span>전문가 정보</span></a>
								</li>
								<li tab-id="FAQ" class="FAQ scroll-button">
									<a href="#pro-comment"><span>질문답변</span></a>
								</li> 
								<li tab-id="community" class="community scroll-button">
									<a href="#pro-knowhow"><span>노하우</span></a>
								</li>
							</ul>
							<div class="observer-container">
								<section id="about">
									<div class="profile-provider-info">
										<div class="profile-provider-info-title" id="pro-info">
											<h2>전문가 정보</h2>
										</div>
										<ul>
									...
									<div class="profile-career">
										...
										<div class="header">
											<img src="${pageContext.request.contextPath}/static/image/career.png" alt="career icon">
											<h3 class="title">총 1개월</h3>
										</div>
										<div class="profile-career-item-wrap">
											<div class="career-list-item profile">
												<div class="contents">
													<h3 class="header"><c:out value="${memberNickname}"/></h3>
													<div class="date-info"> 2023년 3월 - 현재 · 1개월 </div>
												</div>
											</div>
										</div>
									</div>
								...
								<section id="FAQ">
									<div class="profile-qna" id="pro-comment">
										<h2>질문 답변</h2>
										<ul>
											<li>
								...
								<section id="community">
									<div class="profile-knowhow" id="pro-knowhow">
										<h2>전문가의 노하우</h2>
...
<script src="${pageContext.request.contextPath}/static/js/mypage-setting-js/my-profile.js"></script>
</html>