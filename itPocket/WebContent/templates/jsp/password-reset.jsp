...
<body class = "password-reset">
	<div id="app" data-browser="Chrome" data-is-loaded = "true">
		...
		<header class="global-header"> <!-- 헤드 구현 -->
		...
		<div id = "app-body">  <!-- 바디구현  -->
			<div data-v-1b4e1e1c class = "password-reset-container">
				<div data-v-1b4e1e1c class = "password-reset container">
					<h2 data-v-1b4e1e1c>비밀번호 재설정</h2>
					<div data-v-1b4e1e1c class = 'card'>
						<form data-v-1b4e1e1c class>
							<div data-v-1b4e1e1c class = "form-row">
								<div data-v-1b4e1e1c class = "col-12">
									<fieldset data-v-1b4e1e1c class = "form-group" id = "__BVID__77">
										<legend tabindex = "-1"  class = "bv-no-focus-ring col-form-label pt-0" 
										id = "__BVID__77__BV_label_">새로운 비밀번호</legend>
										<div>
											<input data-v-1b4e1e1c name = "password" type = "passeword" 
											placeholder="영문+숫자 조합 8자리 이상 입력해주세요" class = "form-control"
											autocapitalize="off" aria-invalid = "false" id = "__BVID__78">
										</div>
									</fieldset>
								</div>
								<div data-v-1b4e1e1c class = "col-12">
									<fieldset data-v-1b4e1e1c class = "form-group" id = "__BVID__79">
										<legend tabindex = "-1" class = "bv-no-focus-ring col-form-label pt-0"
										id = "__BVID__79__BV_label_">새로운 비밀번호 확인</legend>
										<div>
											<input data-v-1b4e1e1c name = "passwordConfirm"
											type = "password" placeholder = "비밀번호를 한번 더 입력해주세요" 
											class = "form-control" autocapitalize = "off" aria-invalid = "false" 
											id ="__BVID__80">
										</div>
									</fieldset>
								</div>
								<div data-v-1b4e1e1c class = "col-12">
									<button data-v-1b4e1e1c type = "submit" class = "btn btn-submit btn-primary btn-block">
										<span data-v-1b4e1e1c>비밀번호 재설정 완료</span>
										<span data-v-1b4e1e1c style = "display: none;">
											<div data-v-fc3fcce8 data-v-1b4e1e1c class>
												<div data-v-fc3fcce8 class = "indicator-body"
												style = "width: 24px; height: 24px; border-width : 0.25rem;
												border-style = solid; border-color: rgb(255, 255, 255) rgba(255, 255 ,255, 0.2)
												rgba(255, 255, 255, 0.2); border-image: initial;"></div>
												<p data-v-fc3fcce8 style = "display: none;">
											</div>
										</span>
									</button>
								</div>
		...
		<nav id="app-footer" class="footer-container"> <!-- 하단부 구현 -->
