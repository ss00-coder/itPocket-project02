					...
					<div class="contents-wrapper">
						...
						<div class="contents">
							<div class="contents-item">
								...
								<div class="cta">
									<span>노하우 보러가기</span>
									<img class="icon" src="data:image/svg+xml;base64,">
								</div>
							</div>
							<div class="contents-item">
								<h4>Q&A</h4>
