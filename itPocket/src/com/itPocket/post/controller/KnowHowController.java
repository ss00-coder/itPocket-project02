package com.itPocket.post.controller;
	...
	public class KnowHowController implements Action{
		  @Override
		  public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		      ...
		      postDAO.knowHowSelect(pagable).stream().map(post -> new JSONObject(post)).forEach(jsonArray::put);
		      req.setAttribute("KH", jsonArray.toString());
	...
	//	      게시판마다 수정이 필요해보임
		      result.setPath("templates/jsp/master-know-how-free.jsp");
