...
public class KnowHowColumnController implements Action{
	  @Override
	  public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
	      ...
	      postDAO.knowHowColumnSelect(pagable).stream().map(post -> new JSONObject(post)).forEach(jsonArray::put);
	      req.setAttribute("KHC", jsonArray.toString());
...
//	      게시판마다 수정이 필요해보임
	      result.setPath("templates/jsp/master-know-how-column.jsp");
